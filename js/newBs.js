...
for (var i = cur + 1; i < list.length; i++) {
  list[i].className =
    "bespoke-inactive bespoke-after bespoke-after-" +
    (i - cur) +
    " bespoke-slide";
}
for (var i = 0; i < cur; i++) {
  list[i].className =
    "bespoke-slide bespoke-inactive bespoke-before bespoke-before-" + (cur - i);
}
function leftSec() {
  if (cur < list.length - 1 && inSection == true) {
    ...
    for (var i = 0; i < cur; i++) {
      list[i].className =
        "bespoke-slide bespoke-inactive bespoke-before bespoke-before-" +
        (cur - i);
    }
    for (var i = cur; i < list.length; i++) {
      list[i].className =
        "bespoke-slide bespoke-inactive bespoke-before bespoke-after-" +
        (i - cur);
    }
